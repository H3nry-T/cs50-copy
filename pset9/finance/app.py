...
def buy():
    ...
    if not request.form.get("shares"):
        ...
        db.execute("INSERT INTO portfolio (portfolio_user_id, name, symbol, shares, price, total_value_of_stock) VALUES (?, ?, ?, ?, ?, ?) WHERE ", session["user_id"], stock_name, stock_symbol, stock_shares, stock_price, total_value_of_stock)
